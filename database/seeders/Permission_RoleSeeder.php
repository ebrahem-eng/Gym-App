...
class Permission_RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::insert("INSERT INTO role_has_permissions (permission_id, role_id) VALUES (51, 1);");

        DB::insert("INSERT INTO role_has_permissions (permission_id, role_id) VALUES (52, 1);");

        DB::insert("INSERT INTO role_has_permissions (permission_id, role_id) VALUES (53, 1);");

        DB::insert("INSERT INTO role_has_permissions (permission_id, role_id) VALUES (54, 1);");
