...
<head>
    ...
    <title> @yield('title', 'Class Table')</title>
    <!-- Custom CSS -->
                        ...
                        <tbody class="border border-info">
                            @foreach ($classes as $class)
                                <tr>
                                    ...
                                    <td>
                                        <a type="button" class="btn btn-circle btn-primary mt-2 mr-2 " href="{{route('admin.class.edit' , $class->id)}}"><i data-feather="edit-2"
