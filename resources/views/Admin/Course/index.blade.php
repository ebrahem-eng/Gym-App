        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-7 align-self-center">
                    <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Course Manage</h3>
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0 p-0">
                                <li class="breadcrumb-item"><a
                                        href="{{ route('admin.index') }}">Dashboard/Courses/Courses Table</a>
                                </li>
                            </ol>
                        </nav>
                    </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card-body">
                    ...
                    @if (session('message_success_store'))
                        <div class="alert alert-success alert-dismissible bg-success text-white border-0 fade show"
                            role="alert">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                            {{ session('message_success_store') }}
                        </div>
                    @endif
                                        ...
                                        <tr>
                                           ...
                                           <br><br>
                                            @endforeach  </td> 
                                                ...
                                                <form action="{{route('admin.course.destroy' , $result['id'])}}" method="POST">
                                                    @method('delete')
                                                    @csrf
