...
<head>
    ...
    <title> @yield('title', 'Employe Table')</title>
    <!-- Custom CSS -->
                        ...
                        <tbody class="border border-info">
                            @foreach ($employes as $employe)
                                <tr>
                                    ...
                                    <td><a type="button" class="btn btn-circle btn-primary mt-2 mr-2 " href="{{route('admin.employe.edit',$employe->id)}}"><i data-feather="edit-2"
                                                class="feather-icon"></i></a>
                                        <a type="button" class="btn btn-circle btn-dark mt-2 mr-2 " href="#"><i data-feather="key"
                                                class="feather-icon"></i> </a>
                                        <form method="post"
