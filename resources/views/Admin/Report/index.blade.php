                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="{{route('admin.index')}}"><strong>Dashboard</strong>/Reports/Reports Table</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <table class="table">
                        ...
                        <tbody class="border border-info">
                            <tr>
                                ...
                                <td>@Sonu</td>
                                <td>
                                    <button class="btn btn-circle btn-danger "><i data-feather="x" class="feather-icon"></i></button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
