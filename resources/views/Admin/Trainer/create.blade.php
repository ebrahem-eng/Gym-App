...
<head>
    ...
    <title> @yield('title','Add Trainer')</title>
    <!-- Custom CSS -->
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="{{route('admin.index')}}">Dashboard/Trainer/Add Trainer</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="nametext" aria-describedby="name" placeholder="First Name" name="firstName">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <label class="form-label">Work Time Start:</label>
                                                    <input type="time" class="form-control" placeholder="Work Time Start" name="WorkTimeStart">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                <label class="form-label">Work Time End:</label>
                                                    <input type="time" class="form-control" placeholder="Work Time End" name="WorkTimeEnd">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
