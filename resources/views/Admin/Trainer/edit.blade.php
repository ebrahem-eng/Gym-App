...
<head>
    ...
    <title> @yield('title','Update Trainer')</title>
    <!-- Custom CSS -->
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="{{route('admin.index')}}">Dashboard/Trainer/Update Trainer</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="nametext" aria-describedby="name" placeholder="First Name" name="firstName" value="{{$trainer->first_name}}" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                <label class="form-label">Last Name:</label>
                                                    <input type="text" class="form-control" placeholder="Last Name" name="lastName" value="{{$trainer->last_name}}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <label class="form-label">Email:</label>
                                                    <input type="email" class="form-control" placeholder="Email" name="email" value="{{$trainer->email}}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <label class="form-label">Phone:</label>
                                                    <input type="tel" class="form-control" placeholder="Phone" name="phone" value="{{$trainer->phone}}" required>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <label class="form-label">Salary:</label>
                                                    <input type="text" class="form-control" placeholder="Salary" name="salary" value="{{$trainer->salary}}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <label class="form-label">Age:</label>
                                                    <input type="number" class="form-control" placeholder="Age" name="age" value="{{$trainer->age}}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <select class="custom-select mr-sm-2" id="inlineFormCustomSelect"
                                                    ...
                                                    @foreach ($classes as $class)
                                                        <option selected value="{{$trainer->class}}">{{ $class->name }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <label class="form-label">Work Time Start:</label>
                                                    <input type="time" class="form-control" placeholder="Work Time Start" name="WorkTimeStart" value="{{$trainer->work_time_start}}" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                <label class="form-label">Work Time End:</label>
                                                    <input type="time" class="form-control" placeholder="Work Time End" name="WorkTimeEnd" value="{{$trainer->work_time_end}}" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
