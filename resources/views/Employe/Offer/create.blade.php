                                        ...
                                        <tr>
                                           ...
                                           <br><br>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{route('employe.offer.create2' , $result['id'])}}" method="POST">
                                                    @csrf
                                                    <button type="submit" class="btn btn-circle btn-dark mt-2"><i
                                                            data-feather="plus" class="feather-icon"></i></button>
                                                </form>
                                            </td>
                                        </tr>
                                        @endforeach
