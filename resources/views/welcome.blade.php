            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <ul class="features-items">
                        ...
                        <li class="feature-item">
                            <div class="left-icon">
                                <img src="{{ asset('assets/images/features-first-icon.png') }}"
                                    alt="third gym training">
                            </div>
                            <div class="right-content">
                                <h4>Basic Muscle Course</h4>
                                <p>Credit goes to <a rel="nofollow" href="https://www.pexels.com"
                                        target="_blank">Pexels website</a> for images and video background used in this
                                    HTML template.</p>
                                <a href="#" class="text-button">Discover More</a>
                            </div>
                        </li>
    ...
    <section class="section" id="our-classes">
        <div class="container">
            ...
            <div class="row" id="tabs">
                <div class="col-lg-4">
                    <ul>
                        <li><a href='#tabs-1'><img src="{{ asset('assets/images/tabs-first-icon.png') }}"
                                    alt="">First Training Class</a></li>
                        <li><a href='#tabs-2'><img src="{{ asset('assets/images/tabs-first-icon.png') }}"
                                    alt="">Second Training Class</a></a></li>
                        <li><a href='#tabs-3'><img src="{{ asset('assets/images/tabs-first-icon.png') }}"
                                    alt="">Third Training Class</a></a></li>
                        <li><a href='#tabs-4'><img src="{{ asset('assets/images/tabs-first-icon.png') }}"
